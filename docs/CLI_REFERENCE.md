...
**出力ファイル**:
- `manuscript.md` — シーン本文を結合した原稿
- `<slug>_kdp_metadata.json` — タイトル案、説明文、カテゴリ、キーワード
- `*_kdp_readiness_report.md` — KDP 出版準備度レポート（全巻通読レビュー）
...
```
uv run novel-forge doctor --workdir <dir>      # Ollama 接続・モデルの確認
