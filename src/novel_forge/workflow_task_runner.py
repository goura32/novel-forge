...
_TASK_VARIABLES: dict[str, tuple[str, ...]] = {
    ...
    "design.volume.review": ("series_plan", "design", "canon_context", "valid_canon_ids"),
    "design.volume.revise": ("series_plan", "current_volume", "review", "canon_context", "valid_canon_ids"),
    "design.chapter.review": ("series_plan", "design", "canon_context", "valid_canon_ids"),
    "design.chapter.revise": ("series_plan", "current_chapter", "review", "canon_context", "valid_canon_ids"),
    "design.scene.review": ("series_plan", "design", "scene_seed", "canon_context", "valid_canon_ids", "canon_patch_schema"),
    "design.scene.revise": ("series_plan", "current_scene", "review", "scene_seed", "canon_context", "valid_canon_ids", "canon_patch_schema"),
    "write.draft.generate": ("writer_context", "previous_summary"),
    "write.draft.review": ("writer_context", "draft"),
    "write.draft.revise": ("writer_context", "draft", "review"),
    "write.summary.generate": ("writer_context", "draft", "previous_summary"),
