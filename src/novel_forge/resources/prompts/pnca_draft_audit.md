...
- 限定 POV 違反は、POV人物が知り得ない他者の未発話の感情・意図・記憶・画面外の事実を断定した箇所だけに限る。POV人物から見える表情・眉・姿勢・動作・服装・瞳や髪の色、聞こえる声や音、自身の身体反応・感情・場内の解釈は有効な限定 POV 表現であり、推測上の危険だけで issue にしない。WriterView は直接観測できる感覚的詳細を一つずつ列挙する必要はない。
