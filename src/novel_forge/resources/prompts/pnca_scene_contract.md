...
Chapter Contract の `volume_purpose` は親の Volume Contract から固定された巻の到達目的である。この値を否定・開始段階へ巻き戻し・別の目的へ置換してはならない。scene はこの目的を前進させる本文上の出来事を一つ以上必ず含める。最終巻なら、呪い・花冠・敵対勢力・二人の関係のうち、そのsceneに割り当てられた決着を具体的な行為・台詞・状態変化として実現し、契約前夜や初対面の導入へ戻らない。
