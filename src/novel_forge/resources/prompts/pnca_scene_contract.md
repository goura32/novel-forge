...
- `writer_view` は `start_context`、`narrative_contract`、`end_constraints`、`presentation_constraints` のみを持つ。これら四つの内部 object も、本文を生成するための状況・展開・終点・視点表現だけを記述し、要約、監査、Canon、event log、frontier binding、artifact ID、stable ID、本文を示すキーを一切含めない。
