...
## 実行指示
約500〜5000字の自然な日本語本文を `content` に書く。説明・見出し・メタ注釈を本文に混ぜない。台詞・地の文を問わず、すべての本文を自然な日本語のみで書く。中国語（簡体字・繁体字）・英語・ハングルなどの外国語単語やフレーズを、会話文・独白・地の文のいずれにも混入させない。外国語の応酬が必要な場面でも日本語で書く（例：「頭を上げろ」と命じる）。
